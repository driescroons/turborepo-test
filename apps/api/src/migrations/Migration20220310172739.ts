...
export class Migration20220310172739 extends Migration {
  ...
  async up(): Promise<void> {
    this.addSql('alter table "comment" drop constraint if exists "comment_upvotes_check";');
    this.addSql('alter table "comment" alter column "upvotes" type int using ("upvotes"::int);');
